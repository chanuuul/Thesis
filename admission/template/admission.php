...
$result3 = mysql_query("SELECT * FROM admission WHERE username='$username'");
    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
      <div class="container">
        <div class="az-content-left az-content-left-components">
          ...
          <label>Admission instruction</label>
            <nav class="nav flex-column">
              <a href="#" class="nav-link">1. Please enter correct information.</a>
              <a href="#" class="nav-link">2. You can update your information after you submit.</a>
              <a href="#" class="nav-link">3. Please submit the needed file requirments </a>
              <a href="#" class="nav-link">4. always check your notification for admission and examination account.</a>
...
-->
<form action="admissionexec.php" method="POST"  enctype="multipart/form-data">
<div class="az-content-label mg-b-5">Personal Information (N/A if not available)</div>
          ...
          <div class="row row-sm">
			...
			<p class="mg-b-0">Date of Birth</p>
              <input class="form-control" required placeholder="Date of Birth" type="date" name="bday" id="bday" onchange="submitBday()">
            </div><!-- col -->
			<script>
			function submitBday() {
    var Q4A = "";
    ...
    theBday.value = parseInt(Q4A);
}
			</script>
            <div class="col-lg">
			<p class="mg-b-0">Age</p>
              <input class="form-control" required placeholder="Age" type="number" name="age" id="age">
            </div><!-- col -->
            <div class="col-lg">
...
<br>
		...
		<br>
		  ...
		  <p class="mg-b-0">Please select your top two(2) preffered course[]s</p>
		  <br>
		   <div class="row row-sm">
		   <!-- start col -->
            <div class="col-lg">
...
<div class="az-content-label mg-b-5">Requirements</div>
		  <br>
			...
			<p class="mg-b-0">Birth Certificate</p>
              <input class="form-control" placeholder="file1" type="file"  name="file1">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Baptismal Certificate</p>
              <input class="form-control" placeholder="file2" type="file"  name="file2">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Confirmation Certificate</p>
              <input class="form-control" placeholder="file3" type="file"  name="file3">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Marraige Ceritificate</p>
              <input class="form-control"  placeholder="file4" type="file" name="file4">
            </div><!-- col -->
			</div>
		<br>
		<div class="row row-sm">
			...
			<p class="mg-b-0">Form 138 - Report Card<br><br></p>
              <input class="form-control"  placeholder="file5" type="file" name="file5">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Form 137 - Transcript of Records<br><br></p>
              <input class="form-control"  placeholder="file6" type="file" name="file6">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Certificate of Good Moral Character</p>
              <input class="form-control"  placeholder="file7" type="file" name="file7">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Honorable Dismissal and TOR for Transferee</p>
              <input class="form-control"  placeholder="file8" type="file" name="file8">
            </div><!-- col -->
			</div>
