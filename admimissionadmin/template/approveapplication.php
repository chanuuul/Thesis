    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <h2 class="az-content-title">Admission Application - Approved Application</h2>
<!-- 
...
<input type="button" value="Pending Applications" class="btn btn-primary" onclick="window.location='admission.php'">
<br><br>
