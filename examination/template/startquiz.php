...
while($row2 = mysql_fetch_array($result2))
	...
	mysql_query("UPDATE login SET chance = '10' WHERE username = '$username'");
...
<!-- start -->
<div style="width:80vw;background:#FFF;padding:10px;height:100px;">
<div id="logs" style="font-size:30px"></div>
</div>
<div class="row2" style="width:80vw;border:0px solid #000">
  <div class="column2">
    <div class="card2">
      <center>
		<!-- start -->
...
<!-- <iframe id="iframeid" width="100%" height="450px" src="https://face.stcbauanadmission.tech/?username=<?php echo $username ?>" title="YouTube video player" allow="accelerometer; camera *;microphone *; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen scrolling="no"  frameBorder="0"></iframe> -->
<iframe id="iframeid" width="100%" height="450px" src="http://localhost:3000/?username=<?php echo $username ?>" title="YouTube video player" allow="accelerometer; camera *;microphone *; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen scrolling="no"  frameBorder="0"></iframe>
...
$idab = $_GET['id'];
		...
		echo '{"question": "'.$row3["question"].'", "image": "'.$row3['image'].'", "correct": '.$row3["corans"].', "a1":"'.$row3["ansa"].'", "a2":"'.$row3["ansb"].'","a3":"'.$row3["ansc"].'","a4":"'.$row3["ansd"].'","number":"'.$row3['id'].'"},		';
    ...
    if (myAnswers[(lengthofobject-1)]) {
        ...
        for (var i = 0; i < myAnswers.length; i++) {
            if (data.quizcontent[i].correct == myAnswers[i]) {
                ...
                correct++;
             // alert(data.quizcontent[i].number);
		 ...
		 data: 	
		 {
			 number:data.quizcontent[i].number,
			 score:questionscore,
