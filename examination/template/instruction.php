...
<li>No cell phones or other secondary devices in the room or test area
<li>Your desk/table must be clear or any materials except your test-taking device
<li>No one else can be in the room with you
<li>No talking 
<li>The testing room must be well-lit and you must be clearly visible
<li>No dual screens/monitors
<li>Do not leave the camera 
<li>No use of additional applications or internet
<br><br>
<h4>Strictly do not refresh the page while taking the exam</h4>
<?php
$id =$_GET['id'];
?>
<input type="button" value="Start Examination" onclick="window.location='startquiz.php?id=<?php echo $id ?>'" class="btn btn-primary">
