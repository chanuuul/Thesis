      ...
      <div class="container">
        <div class="az-content-body">
          <div class="az-dashboard-one-title">
            <div>
              <h2 class="az-dashboard-title">Guidance Account List</h2>
...
$(document).bind('afterReveal.facebox', function() {
    ...
    $("#opaque").height($(document).height());
		  ...
		  <a href="addguidance.php" class="btn btn-primary" rel="facebox">Create Guidance Account</a> 
		  <br><br>
<input type="search" class="light-table-filter email form-control" data-table="order-table" placeholder="Search"><br>
              ...
              <tbody>
              		<?php
include('../../connect.php');
$result = mysql_query("SELECT * FROM login WHERE type = 'admimissionadmin' ORDER BY ID DESC");
while($row = mysql_fetch_array($result))
{
						...
						echo '<td><a style="width:100%;margin-top:5px" class="btn btn-danger" href="delete2.php?id='.$row["id"].'" onclick="return confirm(\'Are you sure you want to delete this record?\')">Delete Account</a></td>';
                        echo'</tr>';
}
?>                     
