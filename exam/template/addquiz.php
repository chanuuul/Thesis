      ...
      <div class="container">
        <div class="az-content-body">
          <div class="az-dashboard-one-title">
            <div>
              <h2 class="az-dashboard-title">Add Examination </h2>
...
<script type="text/javascript">bkLib.onDomLoaded(nicEditors.allTextAreas);</script>
						...
						<form class="form-horizontal" role="form" action="addquizexec.php" method="POST">
						<input type="hidden" name="teacher" value="<?php echo $username ?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Exam </label>
							...
							<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Number of Minutes for Quiz </label>

										<div class="col-sm-9">
											<input type="number" id="form-field-1" placeholder="Number of Minutes" class="form-control" name="minutes" required/>
										</div>
									</div>
								<div class="form-group">
										...
										<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="Subject" class="form-control" name="subject" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Date Start </label>

										<div class="col-sm-9">
											<input type="date" id="form-field-1" placeholder="Name" class="form-control" name="datestart" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Date End </label>

										<div class="col-sm-9">
											<input type="date" id="form-field-1" placeholder="Name" class="form-control"" name="dateend" required/>
										</div>
									</div>
								<div class="form-group">
									
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Quiz Description </label>

										<div class="col-sm-9">
											<textarea style="width:550px;height:250px" name="description" class="form-control"> </textarea>
										</div>
									</div>
