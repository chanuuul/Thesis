	...
	<?php
											...
											while($row11 = mysql_fetch_array($result11))
											{
												...
												$id11a = $row11['id'];
													...
													include('../../connect.php');
											$id11 = $_GET['id'] ;
											$result = mysql_query("SELECT * FROM questions WHERE questionid = '$id11a'");
											while($row = mysql_fetch_array($result))
											{
...
e id="datatable" style="display:block">
                                    <thead>
                                        <tr>
                                            <th>Subject</th>
                                            <th>Score</th>
                 ...
                 <tabl                       </tr>
					...
					<?php
							$quiz = $_GET['quiz'];
					include('../../connect.php');
					$result = mysql_query("SELECT `score`, COUNT(*) AS `count` FROM results1 WHERE quiz = '$quiz' AND number = '$id11' GROUP by score");
