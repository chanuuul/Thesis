...
<div class="az-content-label mg-b-5">Personal Information</div>
          ...
          <div class="row row-sm">
			...
			<p class="mg-b-0">Given name</p>
              <input class="form-control" placeholder="Given Name" type="text" name="firstname">
            </div><!-- col -->
            <div class="col-lg">
          ...
          <div class="row row-sm">
			...
			<p class="mg-b-0">Date of Birth</p>
              <input class="form-control" placeholder="Date of Birth" type="date" name="bday">
            </div><!-- col -->
			
            <div class="col-lg">
			<p class="mg-b-0">Place of Birth</p>
              <input class="form-control" placeholder="Place of Birth" type="text" name="bplace">
            </div><!-- col -->
          </div>
		  <!-- end row -->
<br>
          ...
          <div class="row row-sm">
			...
			<p class="mg-b-0">Citizenship</p>
              <input class="form-control" placeholder="Citizenship" type="text" name="citizen">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Civil Status</p>
              <input class="form-control" placeholder="Civil Status" type="text" name="civil">
            </div><!-- col -->
			<div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control" placeholder="Religion" type="text" name="religion">
            </div><!-- col -->
          </div>
		  <!-- end row -->
         <br>
		...
		<br>
          ...
          <div class="row row-sm">
		   <div class="col-lg">
			<p class="mg-b-0">Telephone Number</p>
              <input class="form-control" placeholder="Telephone Number" type="text" name="telnum">
            </div><!-- col -->
            <div class="col-lg">
          ...
          <div class="az-content-label mg-b-5">Family Background</div>
		  <br>
			<!-- start row -->
          <div class="row row-sm">
		   <div class="col-lg">
			<p class="mg-b-0">Father's Name</p>
              <input class="form-control" placeholder="Father's Name" type="text" name="fname">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Occupation</p>
              <input class="form-control" placeholder="Occupation" type="text" name="foccupation">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control" placeholder="Religion" type="text" name="freligion">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Contact Number</p>
              <input class="form-control" placeholder="Contact Number" type="text" name="fcontact">
            </div><!-- col -->
          </div>
		  <br>
		  <!-- end row -->
          ...
          <div class="row row-sm">
		   <div class="col-lg">
			<p class="mg-b-0">Mother's Name</p>
              <input class="form-control" placeholder="Father's Name" type="text" name="mname">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Occupation</p>
              <input class="form-control" placeholder="Occupation" type="text" name="moccupation">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control" placeholder="Religion" type="text" name="mreligion">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Contact Number</p>
              <input class="form-control" placeholder="Contact Number" type="text" name="mcontact">
            </div><!-- col -->
          </div>
		  <br>
		  <!-- end row -->
          ...
          <div class="row row-sm">
		   ...
		   <div class="col-lg">
			<p class="mg-b-0">Guarduan's Name</p>
              <input class="form-control" placeholder="Father's Name" type="text" name="gname">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Occupation</p>
              <input class="form-control" placeholder="Occupation" type="text" name="goccupation">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control" placeholder="Religion" type="text" name="greligion">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Contact Number</p>
              <input class="form-control" placeholder="Contact Number" type="text" name="gcontact">
            </div><!-- col -->
          </div>
		  <br>
		  <!-- end row -->
          ...
          <div class="row row-sm">
		   ...
		   <div class="col-lg">
			<p class="mg-b-0">Spouse's Name</p>
              <input class="form-control" placeholder="Father's Name" type="text" name="sname">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Occupation</p>
              <input class="form-control" placeholder="Occupation" type="text" name="soccupation">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control" placeholder="Religion" type="text" name="sreligion">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Contact Number</p>
              <input class="form-control" placeholder="Contact Number" type="text" name="scontact">
            </div><!-- col -->
          </div>
		  <br>
          <div class="row row-sm">
			...
			<p class="mg-b-0">School Last Attended</p>
              <input class="form-control" placeholder="School Address" type="text" name="school">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Year Graduated</p>
              <input class="form-control" placeholder="Year Graduated" type="text" name="graduated">
            </div><!-- col -->
			</div>
          <div class="row row-sm">
            <div class="col-lg">
			<p class="mg-b-0">School Address</p>
              <input class="form-control" placeholder="School Address" type="text" name="saddress">
            </div><!-- col -->
			</div>
		<br>
