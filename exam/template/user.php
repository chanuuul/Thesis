...
$(document).bind('afterReveal.facebox', function() {
    ...
    $("#opaque").height($(document).height());
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											include('../../connect.php');
											$result = mysql_query("SELECT * FROM login WHERE type ='examination' AND uname <> ''");
											while($row = mysql_fetch_array($result))
											{
												$uname =$row['uname'];	
											...
											<a href="view2.php?id='.$row["uname"].'" style="width:100%" class="btn btn-primary" >View Admission</a>
											<a href="delete4.php?id='.$row["username"].'" style="margin-top:10px;width:100%" class="btn btn-danger" onclick="return confirm(\'Are you sure you want to delete this record?\')">Delete User</a></td>';
											echo'	</tr>';
												}
											}
											?>
