...
while($row2 = mysql_fetch_array($result2))
	...
	$id =$_GET['id'];
$result2a = mysql_query("SELECT * FROM admission WHERE username='$id'");
...
<table>
		<tr>
			<td width="33%" valign="top"><img src="../../public/labeled_images/<?php echo $id ?>/1.jpg" style="width:250px;height:200px;float:left"></td>
			<td width="33%" valign="top"><img src="../../public/labeled_images/<?php echo $id ?>/2.jpg" style="width:250px;height:200px;float:left"></td>
			<td width="33%" valign="top"><img src="../../public/labeled_images/<?php echo $id ?>/3.jpg" style="width:250px;height:200px;float:left"></td>
		</tr>
</table>
<br>
			<!-- start row -->
...
<!-- admission print -->
<div id="savepdf" style="display:none">
...
<div class="az-content-label mg-b-5">Personal Information (N/A if not available)</div>
     ...
     <input type="hidden" name="id" value="<?php echo $id ?>">     
          ...
          <div class="row row-sm">
            <div class="col-lg">
			<p class="mg-b-0">Last name</p>
              <input class="form-control"  placeholder="Last Name" type="text" name="lastname" value="<?php echo $lastname ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Given name</p>
              <input class="form-control"  placeholder="Given Name" type="text" name="firstname" value="<?php echo $firstname ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Middle Name</p>
              <input class="form-control"  placeholder="Middle Name" type="text" name="middlename" value="<?php echo $middlename ?>" style="border:0px">
            </div><!-- col -->
          </div>
		  <!-- end row -->
		  <br>
          ...
          <div class="row row-sm">
            <div class="col-lg">
			<p class="mg-b-0">Age</p>
              <input class="form-control"  placeholder="Age" type="number" name="age" value="<?php echo $age ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Gender</p>
			<select  name="gender" class="form-control"  style="border:0px">
				<option><?php echo $gender ?></option>
				<option>Male</option>
				<option>Female</option>
			</select>
            ...
            <div class="col-lg">
			<p class="mg-b-0">Date of Birth</p>
              <input class="form-control"  placeholder="Date of Birth" type="date" name="bday" value="<?php echo $bday ?>" style="border:0px"> 
            </div><!-- col -->
			
            <div class="col-lg">
			<p class="mg-b-0">Place of Birth</p>
              <input class="form-control"  placeholder="Place of Birth" type="text" name="bplace" value="<?php echo $bplace ?>" style="border:0px">
            </div><!-- col -->
          </div>
		  <!-- end row -->
<br>
          ...
          <div class="row row-sm">
            <div class="col-lg">
			<p class="mg-b-0">Citizenship</p>
              <input class="form-control"  placeholder="Citizenship" type="text" name="citizen" value="<?php echo $citizen ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Civil Status</p>
              <input class="form-control"  placeholder="Civil Status" type="text" name="civil" value="<?php echo $civil ?>" style="border:0px">
            </div><!-- col -->
			<div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control"  placeholder="Religion" type="text" name="religion" value="<?php echo $religion ?>" style="border:0px">
            </div><!-- col -->
          </div>
		  <!-- end row -->
         <br>
          <div class="row row-sm">
            <div class="col-lg">
			<p class="mg-b-0">Address</p>
              <input class="form-control"  placeholder="Address" type="text" name="address" value="<?php echo $address ?>" style="border:0px">
            </div><!-- col -->
			</div>
		<br>
			<!-- start row -->
          <div class="row row-sm">
		   <div class="col-lg">
			<p class="mg-b-0">Telephone Number</p>
              <input class="form-control"  placeholder="Telephone Number" type="text" name="telnum"  value="<?php echo $telnum ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Mobile Number</p>
              <input class="form-control"  placeholder="Mobile Number" type="text" name="contact" value="<?php echo $contact ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Email Address</p>
              <input class="form-control"  placeholder="Email Address" type="text" name="email" value="<?php echo $email ?>" style="border:0px">
            </div><!-- col -->
          </div>
		  <br>
          ...
          <div class="row row-sm">
		   <div class="col-lg">
			<p class="mg-b-0">Father's Name</p>
              <input class="form-control"  placeholder="Father's Name" type="text" name="fname"  value="<?php echo $fname ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Occupation</p>
              <input class="form-control"  placeholder="Occupation" type="text" name="foccupation" value="<?php echo $foccupation ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control"  placeholder="Religion" type="text" name="freligion" value="<?php echo $freligion ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Contact Number</p>
              <input class="form-control"  placeholder="Contact Number" type="text" name="fcontact" value="<?php echo $fcontact ?>" style="border:0px">
            </div><!-- col -->
          </div>
		  <br>
		  <!-- end row -->
          ...
          <div class="row row-sm">
		   <div class="col-lg">
			<p class="mg-b-0">Mother's Name</p>
              <input class="form-control"  placeholder="Father's Name" type="text" name="mname" value="<?php echo $mname ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Occupation</p>
              <input class="form-control"  placeholder="Occupation" type="text" name="moccupation" value="<?php echo $moccupation ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control"  placeholder="Religion" type="text" name="mreligion" value="<?php echo $mreligion ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Contact Number</p>
              <input class="form-control"  placeholder="Contact Number" type="text" name="mcontact" value="<?php echo $mcontact ?>" style="border:0px">
            </div><!-- col -->
          </div>
		  <br>
		  <!-- end row -->
          ...
          <div class="row row-sm">
		   ...
		   <div class="col-lg">
			<p class="mg-b-0">Guarduan's Name</p>
              <input class="form-control"  placeholder="Father's Name" type="text" name="gname" value="<?php echo $gname ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Occupation</p>
              <input class="form-control"  placeholder="Occupation" type="text" name="goccupation" value="<?php echo $goccupation ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control"  placeholder="Religion" type="text" name="greligion" value="<?php echo $greligion ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Contact Number</p>
              <input class="form-control"  placeholder="Contact Number" type="text" name="gcontact" value="<?php echo $gcontact ?>" style="border:0px">
            </div><!-- col -->
          </div>
		  <br>
		  <!-- end row -->
          ...
          <div class="row row-sm">
		   ...
		   <div class="col-lg">
			<p class="mg-b-0">Spouse's Name</p>
              <input class="form-control"  placeholder="Father's Name" type="text" name="sname" value="<?php echo $sname ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Occupation</p>
              <input class="form-control"  placeholder="Occupation" type="text" name="soccupation" value="<?php echo $soccupation ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Religion</p>
              <input class="form-control"  placeholder="Religion" type="text" name="sreligion" value="<?php echo $sreligion ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Contact Number</p>
              <input class="form-control"  placeholder="Contact Number" type="text" name="scontact" value="<?php echo $scontact ?>" style="border:0px">
            </div><!-- col -->
          </div>
		  <br>
          <div class="row row-sm">
            <div class="col-lg">
			<p class="mg-b-0">School Last Attended</p>
              <input class="form-control"  placeholder="School Address" type="text" name="school" value="<?php echo $school ?>" style="border:0px">
            </div><!-- col -->
            <div class="col-lg">
			<p class="mg-b-0">Year Graduated</p>
              <input class="form-control"  placeholder="Year Graduated" type="text" name="graduated" value="<?php echo $graduated ?>" style="border:0px">
            </div><!-- col -->
			</div>
          <div class="row row-sm">
            <div class="col-lg">
			<p class="mg-b-0">School Address</p>
              <input class="form-control"  placeholder="School Address" type="text" name="saddress" value="<?php echo $saddress ?>" style="border:0px">
            </div><!-- col -->
			</div>
		<br>
	...
	?>
		 ...
		 <br>
          <div class="row row-sm">
            <div class="col-lg">
			<p class="mg-b-0"><b>Reason for choosing STC</b></p>
			<textarea class="form-control"  style="height:150px;border:0px" name="reason"  style="border:0px"><?php echo $reason ?></textarea>
...
<button onclick="saveDiv('savepdf','Admission Application')"  class="btn btn-secondary" style="width:200px">Export as PDF</button>
          <div class="ht-40"></div>
